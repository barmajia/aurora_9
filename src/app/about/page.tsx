...
import { Sparkles, Users, Award, TrendingUp, Globe, Heart, Shield, Cpu, Zap } from "lucide-react";
  ...
  const values = [
    {
      ...
      description: "Enterprise-grade encryption protecting the integrity of every ecosystem transaction.",
      color: "text-blue-500",
      bg: "bg-blue-500/10"
    },
    {
      ...
      description: "Leveraging advanced computation to provide the fastest commerce experience on the edge.",
    ...
    },
    {
      ...
      description: "Near-zero delay in logistics and data synchronization across our global network.",
    ...
    },
    {
      ...
      description: "A borderless commerce manifesto connecting premium sources with elite users.",
    ...
    <div className="min-h-screen bg-background text-foreground pt-32 pb-24 overflow-hidden relative">
      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        ...
        <div className="text-center mb-24">
          ...
          >
            Evolving the <br />
            <span className="text-blue-600 dark:text-blue-400">Digital Interface</span>
          </motion.h1>
          ...
          >
            Aurora isn&apos;t just an e-commerce platform. It&apos;s a high-performance ecosystem 
            designed for the next generation of premium commerce and industrial-grade security.
          </motion.p>
        </div>
        ...
        >
          {stats.map((stat, idx) => (
            ...
            >
              <div className="text-4xl md:text-5xl font-black italic tracking-tighter text-zinc-900 dark:text-white mb-2 group-hover:scale-110 transition-transform duration-500">
                {stat.value}
              </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-24 items-center mb-32">
          ...
          >
            ...
            <div className="space-y-6 text-zinc-500 dark:text-zinc-400 leading-relaxed text-lg">
              <p>
                Aurora was initiated from a critical need: the demand for a commerce interface 
                that combines the raw power of industrial technology with the elegance of 
                minimalist design.
              </p>
              <p>
                We engineered a platform that prioritizes security, speed, and user experience 
                above all else. Every node in our network is optimized to ensure that the 
                distance between a premium product and your doorstep is minimized to the 
               ...
               <div className="h-full w-full rounded-[2rem] border border-zinc-200 dark:border-zinc-800 flex items-center justify-center relative overflow-hidden">
                  ...
                  <div className="absolute bottom-8 left-8 right-8">
                     <div className="aurora-glass p-6 rounded-2xl border border-white/10">
                        <p className="text-[10px] font-black uppercase tracking-[0.2em] text-blue-500 mb-2">System Status</p>
                        <p className="text-xs font-medium text-white/80 uppercase tracking-widest leading-relaxed">
                           Aurora Ecosystem active. 99.99% Uptime across 32 global regions.
                        </p>
                     </div>
                  </div>
               </div>
        ...
        <div className="mb-32">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {values.map((value, idx) => (
              ...
              >
                <div className={`w-14 h-14 ${value.bg} rounded-2xl flex items-center justify-center ${value.color} mb-8 group-hover:scale-110 transition-transform duration-500`}>
                  <value.icon size={28} />
                </div>
        ...
        >
          ...
          <div className="relative z-10 max-w-4xl mx-auto">
             ...
             <h2 className="text-4xl md:text-6xl font-black italic tracking-tighter uppercase text-white mb-10 leading-[0.9]">
                To democratize <span className="text-blue-500">premium quality</span> through technical excellence.
             </h2>
