...
import { 
  Package, Plus, Search, Edit2, Trash2, Eye, MoreVertical,
  ChevronLeft, Filter, Grid, List, X
} from 'lucide-react';
    ...
    <div className="dashboard-container">
      ...
      {filteredProducts.length === 0 ? (
        <div className="empty-state">
          ...
          <p>{searchQuery ? 'Try adjusting your search' : 'Start by adding your first product'}</p>
          {!searchQuery && (
            <button className="btn-primary" onClick={() => setShowAddModal(true)}>
              <Plus size={20} />
              Add Product
            ...
            <div key={product.id} className="product-card-dashboard glass-card">
              ...
              <div className="product-details">
                ...
                <div className="product-stats">
                  ...
                  <span>⭐ {product.average_rating?.toFixed(1) || '0.0'} ({product.review_count})</span>
                </div>
                ...
                <tr key={product.id}>
                  ...
                  <td>
                    <div className="table-actions">
                      ...
                      <button className="action-btn delete" onClick={() => handleDelete(product.id)}><Trash2 size={14} /></button>
                    </div>
                  </td>
                </tr>
              ))}
