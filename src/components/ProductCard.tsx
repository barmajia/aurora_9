        ...
        <div className="p-6">
          <div className="flex justify-between items-start mb-4">
            ...
            <div className="text-xl font-bold text-zinc-900 dark:text-white">
              <span className="text-sm font-medium text-zinc-400 mr-0.5">$</span>
              {productPrice.toFixed(0)}
              <span className="text-[10px] font-medium text-zinc-400">.{(productPrice % 1).toFixed(2).slice(2)}</span>
            </div>
          </div>
          ...
          <div className="flex items-center justify-between pt-4 border-t border-zinc-100 dark:border-zinc-800">
            ...
            <div className="flex items-center gap-1.5">
               ...
               <span className="text-[9px] font-bold text-zinc-400 uppercase tracking-widest">Stocked</span>
            </div>
          </div>
        </div>
      </div>
