        ...
        <div className="w-full px-6 lg:px-12 flex justify-between items-center gap-8">
            ...
            <div
              className={cn(
                ...
                isScrolled
                  ...
                  : "bg-indigo-500/20 border border-indigo-500/30 group-hover:scale-110",
              )}
            >
              <Factory className="h-6 w-6 text-indigo-500 transition-transform group-hover:rotate-12" />
            </div>
            <div className="flex flex-col hidden sm:flex">
              <span className="text-2xl font-black italic tracking-tighter leading-none text-indigo-500 transition-colors group-hover:text-indigo-400">
                AURORA
              </span>
              <span className="text-[8px] font-black uppercase tracking-[0.5em] text-indigo-500/50 italic mt-1 relative left-[2px]">
                Industrial Core
              </span>
            </div>
          </Link>
          ...
          <div className="flex items-center gap-4">
            ...
            <button className="w-12 h-12 flex items-center justify-center bg-white/5 border border-white/10 rounded-2xl hover:bg-white/10 transition-all relative">
              <Bell size={18} className="text-white/60 hover:text-indigo-500" />
              <span className="absolute top-3 right-3 w-2 h-2 bg-indigo-500 rounded-full border-2 border-[#050508]" />
            </button>
            ...
            <div className="flex items-center gap-3">
              <div className="flex flex-col items-end hidden lg:flex">
                ...
                <span className="text-[8px] font-black uppercase tracking-widest text-indigo-500/50">
                  Optimal Capacity
                </span>
              </div>
              <button
                onClick={() => router.push("/profile")}
                className="w-12 h-12 rounded-2xl bg-indigo-500/10 border border-indigo-500/20 flex items-center justify-center hover:bg-indigo-500/20 transition-all group"
              >
                <User
                  size={18}
          ...
          >
            <div className="flex justify-between items-center mb-16">
              <div className="flex flex-col">
                <span className="text-3xl font-black italic tracking-tighter text-indigo-500 leading-none">
                  AURORA
                </span>
                <span className="text-[10px] font-black uppercase tracking-[0.5em] text-indigo-500/50 italic mt-1 relative left-[2px]">
                  Industrial Core
                </span>
              </div>
              <button
                      ...
                      <div
                        className={cn(
                          ...
                          isActive
                            ...
                            : "bg-white/5 border-white/5 group-hover:bg-indigo-500/10 group-hover:border-indigo-500/20",
                        )}
                      >
                        <Icon
                          size={20}
                          className={cn(
                            ...
                            isActive
                              ? "text-indigo-500"
                              : "text-white/40 group-hover:text-indigo-500 group-hover:translate-x-2",
                          )}
                        />
                      </div>
                      <span
            ...
            <div className="mt-auto pt-10 border-t border-white/5 flex gap-4">
              <button
                ...
                className="flex-1 h-16 rounded-[2rem] bg-indigo-500/20 text-indigo-500 border border-indigo-500/30 text-xs font-black uppercase tracking-widest flex items-center justify-center gap-3"
              >
                <User size={18} />
                Profile
              </button>
